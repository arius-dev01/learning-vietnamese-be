...
//        double tmp = 33.3333333333;
    ...
    public LessonDTO addLesson(LessonDTO lessonDTO) {
        ...
        Lesson lesson = Lesson.builder()
                ...
                .contentJa(lessonDTO.getContentJa())
                .titleJa(lessonDTO.getTitleJa())
                .content(lessonDTO.getContent())
                .descriptionJa(lessonDTO.getDescribeJa())
                .updated(LocalDateTime.now())
                .video_url(lessonDTO.getVideo_url())
